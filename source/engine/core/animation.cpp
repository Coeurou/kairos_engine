...
void variant_animation::start_impl() { expects(my_value != nullptr, "Nothing to animate"); }
...
void variant_animation::resume_impl() { expects(my_value != nullptr, "Nothing to animate"); }
