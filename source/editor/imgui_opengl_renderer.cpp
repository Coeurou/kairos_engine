...
imgui_opengl_renderer::imgui_opengl_renderer(const opengl_context* gl_context) : my_gl_context(gl_context) {
}
...
void imgui_opengl_renderer::cleanup()
{
    cleanup_opengl_data();
}
...
void imgui_opengl_renderer::setup_render_state(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    glVertexAttribPointer(my_attribute_location_vertex_pos,   2, GL_FLOAT,         GL_FALSE, sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, pos));
    glVertexAttribPointer(my_attribute_location_vertex_uv,    2, GL_FLOAT,         GL_FALSE, sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, uv));
    glVertexAttribPointer(my_attribute_location_vertex_color, 4, GL_UNSIGNED_BYTE, GL_TRUE,  sizeof(ImDrawVert), (GLvoid*)IM_OFFSETOF(ImDrawVert, col));
}